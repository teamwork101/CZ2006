    ...
    public partial class Layout1 : System.Web.UI.Page
    {
        ...
        protected void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= totalLots; i++)
            {
                ...
                if (labelvalue.ID == "Label11" || labelvalue.ID == "Label12") //wheelchair lots color different
                {
        ...
        private void availableLots()
        {
            ...
            int availableLots = rndAvailLots.Next(1, 40); //from 1 to 39 only
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                lotsNum = rndLotsNum.Next(1, 40); //from 1 to 39 only
